...
/*
    ...
    Is it possible to overload main method?
        ...
        if you do, it is not the main method we use to execute code

    Can main method be overridden?

        no, because it is static

    if you are static can override?
        no you cannot override the method, they will become hidden if you declare a method with the same name
 */